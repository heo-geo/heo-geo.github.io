...
1. Describe what “Cart Attributes”, “Cart Notes”, and “Line Item Properties” are, and explain the differences between them.
    
2. Could you provide some examples of scenarios in which we can use each of these, and explain why?
    
3. Where are these data displayed on an order page?
    
4. Is it possible to add this data using the Shopify Cart API?
    
5. Describe what “**private properties**” and “**attributes**” are and how they can be implemented in the store.
